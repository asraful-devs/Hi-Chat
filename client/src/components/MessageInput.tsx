...
function MessageInput() {
    ...
    return (
        <div className='p-2 md:p-4 border-t border-slate-700/50 shrink-0'>
            {imagePreview && (
            ...
            >
                ...
                <button
                    ...
                    className='bg-linear-to-r from-cyan-500 to-cyan-600 text-white rounded-lg px-3 md:px-4 py-2 font-medium hover:from-cyan-600 hover:to-cyan-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed'
                >
